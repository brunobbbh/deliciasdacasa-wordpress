...
function wellington_customize() {
	wp_die(
		sprintf( esc_html__( '%1$s requires at least WordPress version %2$s. You are running version %3$s. Please upgrade and try again.', 'wellington' ), 'Wellington', '4.7', $GLOBALS['wp_version'] ),
		'',
		array(
			'back_link' => true,
		)
