...
function wellington_customize_register_blog_settings( $wp_customize ) {
	...
	$wp_customize->selective_refresh->add_partial(
		'wellington_theme_options[post_layout]',
		array(
	...
	$wp_customize->add_setting(
		'wellington_theme_options[blog_title]',
		array(
			'default'           => '',
			'type'              => 'option',
	...
	$wp_customize->add_setting(
		'wellington_theme_options[blog_description]',
		array(
			'default'           => '',
			'type'              => 'option',
			'transport'         => 'postMessage',
	...
	$wp_customize->add_setting(
		'wellington_theme_options[read_more_text]',
		array(
	...
	$wp_customize->add_control(
		new Wellington_Customize_Header_Control(
			$wp_customize,
			'wellington_theme_options[blog_magazine_widgets_title]',
			array(
